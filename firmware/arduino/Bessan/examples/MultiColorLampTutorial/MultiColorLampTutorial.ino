...
// declare bessan so that you can call functions with it
Bessan bessan;
...
void setup()  
{
  ...
  bessan.registerFunction(red, 'o');
  bessan.registerFunction(green, 'p');  
  bessan.registerFunction(blue, 'q'); 
...
{
  analogWrite(redLed, bessan.getInt());
}
...
{
  analogWrite(greenLed, bessan.getInt());
}
...
{
  analogWrite(blueLed, bessan.getInt());
}
